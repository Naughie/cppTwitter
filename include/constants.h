...
static char TMP_DIR[]          = "/tmp/twitter_cpp";
static char TMP_LOG[]          = "/tmp/twitter_cpp/request_log";
static char TMP_TWEET_IDS[]    = "/tmp/twitter_cpp/tweet_ids";
static char TMP_HOMETIMELINE[] = "/tmp/twitter_cpp/home_timeline";

static char PATH_GET_HOME_TIMELINE[] = "/1.1/statuses/home_timeline.json";
static char PATH_POST_TWEET[]        = "/1.1/statuses/update.json";
